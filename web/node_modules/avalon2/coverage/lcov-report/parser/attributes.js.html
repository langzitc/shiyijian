...
<html lang="en">
<head>
    <title>Code coverage report for parser/attributes.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">parser/</a> attributes.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
        ...
        if(type === 'controller' || type === 'important')
            continue
        <span class="missing-if-branch" title="else path not taken" >E</span>if (directives[type]) {
&nbsp;
            var binding = {
                type: type,
                param: arr[2],
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!uniq[binding.name]) {
...
&nbsp;
     ...
     if(hasIf){
        ...
        for(var i = 0, el; el = bindings[i++];){
            ret.push(el)
            <span class="missing-if-branch" title="else path not taken" >E</span>if(el.type === 'if'){
                return ret
            }
        }
     }
