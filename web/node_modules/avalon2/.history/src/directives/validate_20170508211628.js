...
var valiDir = avalon.directive('validate', {
    diff: function(validator) {
        ...
        if (isObject(validator)) {
            ...
            console.log(vdom.dom, '!!!', vdom.vmValidator)
    ...
    update: function(vdom) {
        ...
        console.log(vdom.vmValidator, '=====', validator)
        var dom = vdom.dom
        if (!validator.dom) {
            validator.dom = dom
        }
        ...
        function onManual() {
            var v = this
            console.log(this.name, this.dom, '!!')
    ...
    validateAll: function(callback) {
        var validator = this
        var vdom = this.vdom
        console.log(validator.name, vdom.dom, '222221')
