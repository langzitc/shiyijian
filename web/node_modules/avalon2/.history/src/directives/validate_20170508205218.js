...
var valiDir = avalon.directive('validate', {
    ...
    update: function(vdom) {
        ...
        var dom = validator.dom = validator.dom || vdom.dom
        dom._ms_validate_ = validator
        collectFeild(vdom.children, validator.fields, validator)
        ...
        function onManual() {
            var v = this._ms_validate_
            if (v) {
                console.log(v.name, this)
            }
    ...
    validateAll: function(callback) {
        var validator = this
        var vdom = this.vdom
        console.log(validator.dom, '222221')
    ...
    validate: function(field, isValidateAll, event) {
        ...
        console.log('isValidateAll', isValidateAll)
        return Promise.all(promises).then(function(array) {
            if (!isValidateAll) {
...
function singleValidate(e) {
    ...
    validator && validator.validate(duplex, 0, e)
}
