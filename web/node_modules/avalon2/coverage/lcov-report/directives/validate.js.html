...
<div class='wrapper'>
  <div class='pad1'>
    ...
    <div class='clearfix'>
      ...
      <div class='fl pad1y'>
        <span class="strong">6 statements, 1 function, 4 branches</span>
...
&nbsp;
        ...
        var type = window.netscape ? 'keypress' : <span class="branch-1 cbranch-no" title="branch not covered" >'focusin'</span>
...
<span class="cstat-no" title="statement not covered" >            avalon.warn('要想使用onManual方法，必须在validate对象预定义一个空的onManual函数')</span>
        }
...
&nbsp;
        /* istanbul ignore if */
        <span class="missing-if-branch" title="else path not taken" >E</span>if (vmValidator.validateAllInSubmit) {
...
<span class="cstat-no" title="statement not covered" >        dom = dom.parentNode</span>
    }
...
function validateAllInSubmitFn(e) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (v &amp;&amp; v.onManual) {
        v.onManual()
    }
}
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function findValidator(e) {</span>
...
<span class="cstat-no" title="statement not covered" >        var msValidator = getValidate(dom)</span>
<span class="cstat-no" title="statement not covered" >        if (msValidator &amp;&amp; avalon.Array.ensure(msValidator.fields, duplex)) {</span>
<span class="cstat-no" title="statement not covered" >            bindValidateEvent(duplex, msValidator)</span>
        }
    }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function singleValidate(e) {</span>
<span class="cstat-no" title="statement not covered" >    var dom = e.target</span>
<span class="cstat-no" title="statement not covered" >    var duplex = dom._ms_duplex_</span>
<span class="cstat-no" title="statement not covered" >    var msValidator = getValidate(e.target)</span>
<span class="cstat-no" title="statement not covered" >    msValidator &amp;&amp; msValidator.validate(duplex, 0, e)</span>
}
&nbsp;
...
<span class="cstat-skip" title="statement not covered" >            var dom = e.target</span>
<span class="cstat-skip" title="statement not covered" >            var field = dom._ms_duplex_</span>
<span class="cstat-skip" title="statement not covered" >            var validator = getValidate(e.target)</span>
<span class="cstat-skip" title="statement not covered" >            validator &amp;&amp; validator.onReset.call(dom, e, field)</span>
        })
    }
}
var rformat = /\\?{{([^{}]+)\}}/gm
