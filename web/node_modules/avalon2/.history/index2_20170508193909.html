...
<body>
        ...
        var vm = avalon.define({
            ...
            validate: {
                ...
                onValidateAll: function(reasons) {
                    ...
                    if (reasons.length) {
                        // 表单有错误
                        console.log("有验证没有通过", reasons.map(function(e) {
                            return e.getMessage()
                        }).join(' '));
                        return false;
                    } else {
    ...
    <div ms-controller="test">
        ...
        <form :validate="@validate2" id="f1" :attr="{ action: @action }">
            <input type="text" placeholder="Insert your email" :duplex="@email" :rules="{ required: true, email:true }" />
            <input type="submit" value="新建邮箱" :click="@add" />
            <input type="submit" value="修改邮箱" :click="@update" />
        </form>
    </div>
</body>
