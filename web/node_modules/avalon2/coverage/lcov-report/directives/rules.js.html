...
<html lang="en">
<head>
    <title>Code coverage report for directives/rules.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">directives/</a> rules.js
    </h1>
    <div class='clearfix'>
...
avalon.directive('rules', {
    diff: function (rules) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (isObject(rules)) {
            var vdom = this.node
...
function isCorrectDate(value) {
    if (typeof value === "string" &amp;&amp; value) { //是字符串但不能是空字符
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (arr.length === 3 &amp;&amp; arr[0].length === 4) {
...
avalon.shadowCopy(avalon.validators, {
    ...
    equalto: {
        ...
        get: function (value, field, next) {
            ...
            var other = avalon(document.getElementById(id)).val() || <span class="branch-1 cbranch-no" title="branch not covered" >""</span>
            next(value === other)
            return value
        }
    },
