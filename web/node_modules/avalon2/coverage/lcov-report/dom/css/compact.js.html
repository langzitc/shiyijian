...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { avalon, oneObject,msie } from '../../seed/core'
import { cssMap, cssHooks, getWindow } from './share'
&nbsp;
/* istanbul ignore if */
<span class="skip-if-branch" title="if path not taken" >I</span>if (msie &lt; 9) {
<span class="cstat-skip" title="statement not covered" >    avalon.shadowCopy(cssMap, oneObject('float','styleFloat'))</span>
