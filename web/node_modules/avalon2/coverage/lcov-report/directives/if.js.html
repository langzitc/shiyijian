...
<html lang="en">
<head>
    <title>Code coverage report for directives/if.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">directives/</a> if.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">19×</span>
<span class="cline-any cline-yes">19×</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { avalon, createAnchor } from '../seed/core'
&nbsp;
avalon.directive('if', {
    delay: true,
    priority: 5,
