...
<html lang="en">
<head>
    <title>Code coverage report for seed/cache.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">seed/</a> cache.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    get(key) {
        ...
        //  &lt;--- add direction --
        //   A  B  C  &lt;D&gt;  E
        <span class="missing-if-branch" title="else path not taken" >E</span>if (entry.newer) {
            // 处理 newer 指向
            if (entry === this.head) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.tail) {
            // 将E的newer指向D
