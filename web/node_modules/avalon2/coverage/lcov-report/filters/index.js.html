...
<html lang="en">
<head>
    <title>Code coverage report for filters/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">filters/</a> index.js
    </h1>
    <div class='clearfix'>
...
avalon.composeFilters = function() {
    ...
    return function(value) {
        for (var i = 0, arr; arr = args[i++];) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof filter === 'function') {
                arr[0] = value
                try {
...
<span class="branch-1 cbranch-no" title="branch not covered" >            str</span>
    },
    ...
    currency(amount, symbol, fractionSize) {
        return (symbol || '\u00a5') +
            numberFilter(amount,
                isFinite(fractionSize) ? /* istanbul ignore else*/ <span class="branch-0 cbranch-no" title="branch not covered" >fractionSize </span>: 2)
    }
}, { filterBy, orderBy, selectBy, limitBy }, eventFilters)
&nbsp;
export { avalon }</pre></td></tr>
</table></pre>
